...
if (isset($_POST['submitBtn'])) {
    ...
    $db = new DBConnect();
    $flag = $db->registerUser($firstName, $lastName, $email,$password, $dob, $gender, $bType, $address, $city, $mobile);
...
<div class="container"id="r1">
    ...
    <div class="col-md-6">
        ...
        <div class="panel panel-default"id="p100">
            <div class="panel-heading"id="ph100">
                <div class="col-md-4  ">
                    <img src="assets/images.png" class="img img-responsive">
                </div>
