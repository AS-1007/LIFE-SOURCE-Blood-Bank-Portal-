...
<div class="container-fluid"style="border:4px solid black;margin-top: 10px;margin-bottom: 15px;background-image: url('assets/download3.jpg');background-repeat: no-repeat;background-size: cover;box-shadow: 10px 10px ;">
    <div class="row">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9 col-md-12 col-sm-4 radio-inline">
