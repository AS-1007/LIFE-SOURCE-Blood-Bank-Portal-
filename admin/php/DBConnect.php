...
class DBConnect {
    ...
    public function auth(){
        ...
        if(! isset($_SESSION['username'])){
            header("Location: http://localhost/LifeSource/admin");
        }
    }
    ...
    public function checkAuth(){
        session_start();
        if(isset($_SESSION['username'])){
            header("Location: http://localhost/LifeSource/admin/home.php");
        }
    }
    ...
    public function addEmployee($username,$password,$firstName,$middleName,$lastName,$designation,$landline,$mobile,$birthDay){
        $stmt = $this->db->prepare("INSERT INTO employees (f_name,m_name,l_name,username,password,b_day,designation,landline,mobile_nr)"
                . "VALUES (?,?,?,?,?,?,?,?,?)");
        if($stmt->execute([$firstName,$middleName,$lastName,$username,$password,$birthDay,$designation,$landline,$mobile]))
            return true;
        else
